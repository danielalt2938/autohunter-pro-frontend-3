...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Get the ID token to verify the user exists in our database
      ...
      alert(error instanceof Error ? error.message : 'An error occurred during Google login');
    } finally {
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md bg-[#FFE5E5] border-none">
          <CardHeader className="space-y-1">
            ...
            <CardTitle className="text-2xl font-bold text-center">Welcome to AutoHunter Pro</CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            >
              ...
              <span className="text-lg font-medium">{isGoogleLoading ? 'Signing in...' : 'Continue with Google'}</span>
            </Button>
          </CardContent>
          <CardFooter className="flex flex-col space-y-4">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-[#333333]/60">
                By logging in, you agree to AutoHunter Pro's Terms of Service and Privacy Policy.
              </p>
            </div>
